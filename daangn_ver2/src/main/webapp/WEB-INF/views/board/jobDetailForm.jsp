	...
	<div id="fleaDe_wrap">
		<div class="flea_all" id="fleaDe_title_area">
			...
			<div id="flea_id_area">
				...
				<div id="flea_address">조회수 ${b.count }</div>
			</div>
		...
		<div class="flea_all" id="fleaDe_text_area">
			<div id="job_title"><span><strong>${b.title }</strong></span></div>
			<div>
				...
				<div class="map_text_area">
					...
					<div class="map_text_area_2"><span>${b.address }</span></div>
				</div>
				<div class="map_text_area" id="date_area">
					<div class="map_text_img"><img src="resources/css_img/month.png"></div>
					<div class="map_text_area_2"><span>${b.jobDate }</span></div>
				</div>
			</div>
